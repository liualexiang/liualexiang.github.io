...
除了单独创建css文件，然后通过link引用之外，还可以将css直接写到html页面link引用之外，还可以将css直接写到html页面�之外，还可以将css直接写到html页面link引用之外，还可以将css直接写到html页面��之外，还可以将css直接写到html页面link引用之外，还可以将css直接写到html页面